...
gt_path = base_dir / "Bark" / "gt" / "Bayer_Bark_GT_ISO100_sha1=f15da1140d949ee30c15ce7b251839a7b7a41de7.cr2"
...
for dy, dx, description in test_shifts:
    ...
    print(f"  V1 (original with negation):  {fft_v1}, loss={loss_v1:.6f} {'✅' if fft_v1 == (dy,dx) else '❌'}")
    print(f"  V2 (no negation):             {fft_v2}, loss={loss_v2:.6f} {'✅' if fft_v2 == (dy,dx) else '❌'}")
    print(f"  V3 (swapped args):            {fft_v3}, loss={loss_v3:.6f} {'✅' if fft_v3 == (dy,dx) else '❌'}")
...
noisy_path = base_dir / "Bark" / "Bayer_Bark_ISO800_sha1=ba86f1da64a4bb534d9216e96c1c72177ed1e625.cr2"
...
print(f"V1 (original with negation):  {fft_v1}, loss={loss_v1:.6f} {'✅' if fft_v1 == (4,-4) else '❌'}")
print(f"V2 (no negation):             {fft_v2}, loss={loss_v2:.6f} {'✅' if fft_v2 == (4,-4) else '❌'}")
print(f"V3 (swapped args):            {fft_v3}, loss={loss_v3:.6f} {'✅' if fft_v3 == (4,-4) else '❌'}")
