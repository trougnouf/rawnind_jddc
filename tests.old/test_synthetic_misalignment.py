...
def test_synthetic_bayer():
    ...
    gt_file = base_path / "gt" / "Bayer_Bark_GT_ISO100_sha1=f15da1140d949ee30c15ce7b251839a7b7a41de7.cr2"
...
def test_synthetic_xtrans():
    ...
    gt_file = base_path / "gt" / "X-Trans_books_GT_ISO200_sha1=b2add962f3fd1cd828a1cd5e3c29f7226aebb6df.raf"
