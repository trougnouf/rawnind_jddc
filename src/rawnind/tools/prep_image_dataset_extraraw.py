...
def fetch_crops_list(fpath: str, ds_base_dpath: str) -> list[dict]:
    ...
    bayer_image_set_dpath = os.path.join(ds_base_dpath, "crops", "DocScan", "bayer")
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        bayer_ds_dpath = os.path.join(EXTRARAW_DS_DPATH, dataset, "DocScan", "bayer")
        args_in = []
        ...
        for result in tqdm.tqdm(results):  # FIXME
            ...
            linrec2020_fpath = (
                result["bayer_fpath"].replace("DocScan/bayer", "proc/lin_rec2020") + ".tif"
            )
