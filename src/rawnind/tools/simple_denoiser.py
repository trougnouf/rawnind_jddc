...
MODEL_FPATH = "/orb/benoit_phd/models/rawnind_denoise/DenoiserTrainingBayerToProfiledRGB_4ch_2023-08-30-mb_bayer_msssim_mgoutfix_-2/saved_models/iter_3825000.pt"
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        input_image, rgb_xyz_matrix = denoise_image.load_image(
            args.input_fpath, device=device
        )
        input_image = input_image.unsqueeze(0)
        model = raw_denoiser.UtNet2(in_channels=4 if model_is_bayer else 3, funit=32)
