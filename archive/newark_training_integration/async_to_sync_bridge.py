...
class AsyncPipelineBridge:
    ...
    Attributes:
        ...
        cfa_filter: Filter by CFA type (e.g., "bayer", "xtrans")
    ...
    def __init__(
        ...
        if cfa_filter and cfa_filter not in ["bayer", "xtrans", "quad_bayer"]:
    ...
    async def collect_scenes_async(
        self,
        ...
        logger.info(f"Starting scene collection with timeout={timeout_seconds}s")
